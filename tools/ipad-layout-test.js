...
assert('legacy panel opens near top', cssRuleIncludes('html.legacyIpadLandscape .float-panel', 'top:72px') && cssRuleIncludes('html.legacyIpadLandscape .float-panel', 'bottom:auto'));
